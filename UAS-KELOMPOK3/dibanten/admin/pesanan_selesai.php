			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pesanan Selesai</h2>
						
						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Daftar Pesanan Selesai</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sql = "SELECT pembelian.*,pembeli.*,toko.* FROM pembelian,pembeli,toko WHERE pembelian.idpembeli_pembelian=pembeli.id_pembeli
													AND pembelian.idtoko_pembelian=toko.id_toko AND status_pembelian='Pesanan Selesai'
